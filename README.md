...
2. What is an event?
    An event allows JavaScript to register different event handlers on elements in an HTML document.
3. What is an event listener?
    A function that listens for an event to take place so you can use the event to trigger an action.
4. Why would we convert a NodeList into an Array?
    So we can iterate over the list and work with the data.
5. What is a component?
    A component is a reusable chunk of code usually made of javascript, but renders out html and css.


    Resubmitting for codegrade. I think it wasn't working correctly.